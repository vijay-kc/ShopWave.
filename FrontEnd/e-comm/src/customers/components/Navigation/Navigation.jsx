...
export default function Navigation() {
 ...
 const handleUserOrder=()=>{
  ...
  const cartItemCount = carts.cart?.cartItems?.length || 0;
  return (
                  ...
                  {auth.user?.firstName ? (
                    <div >
                      ...
                      >
                        ...
                        <MenuItem onClick={handleUserOrder}>My Orders</MenuItem>
                        {auth.user?.role == "ADMIN"&& <MenuItem onClick={handleDashboard}>Dashboard</MenuItem>}
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Button onClick={handleCartClick} className="group -m-2 flex items-center p-2">
                    <ShoppingBagIcon
                      ...
                      aria-hidden="true"
                    />
                    {auth.user && (<span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">{carts.cart?.cartItems.length }
                    </span>)}
